...
if __name__ == "__main__":
    ...
    parser.add_argument('-val_path', type=str,
                        help='path to validation folder with wav and csv files')
    parser.add_argument('-evaluation_file', type=str,
                        help='path and name of prediction file')
    parser.add_argument('-new_evaluation_file', type=str,
                        help="name of prost processed prediction file to be saved")

    args = parser.parse_args()

    post_processing(args.val_path, args.evaluation_file,
